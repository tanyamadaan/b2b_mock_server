...
export const SRV_INTENT_TAGS = ["finder_fee_type","finder_fee_amount","FINDER_FEE_TYPE","FINDER_FEE_AMOUNT","BAP_TYPE"];

export const TAGS_DESCRIPTOR_CODE = ["BAP_TERMS","BAP_DETAILS","BAP_TYPE"];
