...
const intializeRequest = async (
    ...
    let itemsArr:any=[]
        ...
        itemsArr = providers[0].items = [
          providers[0]?.items.map(
            ({
              ...
              id,
              parent_item_id,
              location_ids: [{ id: location_ids[0] }],
              tags: [tags[0]],
            })
          )[0],
        ];
        itemsArr = itemsArr.map((itm:any) => {
          return {
            ...itm,
          ...
          itemsArr = providers[0].items = [
            providers[0]?.items.map(
              ({
                ...
                parent_item_id,
                location_ids: [{ id: location_ids[0] }],
                fulfillment_ids: { id: fulfillment_ids[0] },
                tags: [tags[0]],
              })
            )[0],
          ];
      ...
      console.log("providersssssssssss",providers[0]?.items)
			items = itemsArr
