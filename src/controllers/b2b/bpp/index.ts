...
import { updateFulfillmentController, updatePrepaidController } from "./update";
...
bppRouter.post(
	"/status-delivered",
	jsonSchemaValidator(statusSchema),
	statusDeliveredController
);
bppRouter.post(
...
bppRouter.post(
	"/update-fulfillment",
	jsonSchemaValidator(updateSchema),
	updateFulfillmentController
);
bppRouter.post(
	"/update-prepaid",
	jsonSchemaValidator(updateSchema),
	updatePrepaidController
);
